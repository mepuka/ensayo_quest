 ...
 * Schemas imported from @ensayo/shared for single source of truth.
 *
...
// Import schemas from shared package - single source of truth
import {
  CreateRoomResponse,
  SubmitTurnResponse,
  TurnAudioResponse,
...
// =============================================================================
// Additional Input Types (not in shared - frontend-specific)
// =============================================================================
...
export type { CreateRoomInput, SubmitTurnInput, CreateRoomResult, SubmitTurnResult, UploadAudioResult };
